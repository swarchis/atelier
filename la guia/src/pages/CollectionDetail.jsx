...
export default function CollectionDetail() {
  ...
  const members = products.filter(p => p.collectionId === id);
    ...
    <>
      <div className="topbar">
        <div className="topbar-left">
          ...
          <div className="page-sub">{collection.launchWindow}</div>
        </div>
        <div className="topbar-right">
          {collection.timelineConflict && <span className="tag tag-amber">Timeline conflict</span>}
        </div>
      </div>
      ...
      <div className="content">
        <div className="stats-row">
          ...
          <div className="stat-card" style={{ '--stat-accent': 'var(--c-home)' }}>
            ...
            <div className="stat-value" style={{ fontSize: 17 }}>{collection.launchWindow}</div>
          </div>
        </div>
