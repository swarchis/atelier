...
export const PLANS = [
  {
    ...
    description: 'Organize one product and build its tech pack by hand.',
    price: '$0',
    priceSuffix: 'forever',
    priceId: null,
  ...
  },
  {
    ...
    description: 'Unlimited products, plus sales figures, financial forecasting, marketing tools and team chat.',
    price: '$79.99',
    priceSuffix: '/month',
    priceId: 'premium',
