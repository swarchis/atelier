...
export const PLANS = [
  ...
  },
  {
    ...
    summary: [
      ...
      'AI vendor search and fit analysis',
    ...
    features: [
      ...
      { text: 'Collections and product grouping' },
      { text: 'Moodboards, AI color palettes and trend research' },
      { text: 'Materials library with cost history and supplier links' },
      { text: 'PDF and spreadsheet (CSV) exports' },
