...
// High-Fidelity Technical Fashion Flats
// Drawn on a precise 60x72 grid with curved drapes, ribbing, seams, and topstitching details.
// These emulate professional Adobe Illustrator CADs used in actual spec sheets.
const PATHS = {
  hoodie: (
    <>
      {/* Outer Hood */}
  ...
  bag: (
    <>
      {/* Tote Bag Structure */}
      <path d="M 14 26 H 46 L 43 62 H 17 Z" />
      {/* Straps (Arced cleanly behind and in front) */}
      <path d="M 22 26 C 22 6 38 6 38 26" strokeWidth="2.5" />
      <path d="M 22 26 L 22 31 M 38 26 L 38 31" strokeWidth="2.5" />
      {/* Top Hem / Gusset */}
      <path d="M 14 29 H 46 M 17 62 L 20 54 M 43 62 L 40 54" strokeWidth="1.2" />
      <path d="M 20 54 H 40" strokeWidth="1" />
      {/* Bottom corner gusset seams */}
      <line x1="20" y1="54" x2="20" y2="62" strokeWidth="1" />
      <line x1="40" y1="54" x2="40" y2="62" strokeWidth="1" />
    </>
  ),
};
